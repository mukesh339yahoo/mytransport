...
file_path = "/Users/shailysharma/CursorAI/mytransport/development/frappe-bench/apps/mytransport/mytransport/mytransport/doctype/transport_invoice/transport_invoice.py"
...
print("transport_invoice.py updated")
