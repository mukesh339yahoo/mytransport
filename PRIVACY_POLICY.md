...
This Privacy Policy applies to all information collected through our application, **MyTransport**, and/or any related services, sales, marketing, or events.
...
The personal information that we collect depends on the context of your interactions with us and the application, and may include:
- **Contact Information:** Name, phone numbers, email addresses, and postal addresses.
- **Business Details:** GST Numbers, PAN numbers, and business names for consignors, consignees, and vehicle owners.
- **Vehicle & Driver Details:** Vehicle numbers, vehicle types, driver names, and driver contact numbers.
...
- To fulfill and manage your transport orders, lorry receipts, and billing.
- To communicate with vehicle owners, drivers, consignors, and consignees.
